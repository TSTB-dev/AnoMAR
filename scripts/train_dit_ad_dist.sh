...
python3 ./src/train_dit_feature_dist.py --config_path ./configs/exp_unet_feature_ad_smc/w2d256ep1000.yml --devices cuda:0 cuda:1 cuda:2 cuda:3 cuda:4 cuda:5 cuda:6 cuda:7
