...
python src/evaluate_repaint.py \
   ...
   --start_step 99 \
    ...
    --num_resamples 1 \
    --num_jumps 1 \
    --output_dir ./results/ad_unet_vae/screw \
    --model_ckpt ./results/ad_unet_vae/screw/model_latest.pth \
    --config_path ./results/ad_unet_vae/screw/config.yaml \
    --save_images \
    --device cuda \
    --batch_size 1 \
    --sample_indices 0 1
...
#     --num_resamples 4 \
#     --num_jumps 4 \
#     --output_dir ./results/loco_dit_vae/screw_bag \
#     --model_ckpt ./results/loco_dit_vae/screw_bag/model_latest.pth \
#     --config_path ./results/loco_dit_vae/screw_bag/config.yaml \
#     --save_images \
#     --device cuda \
#     --batch_size 1 \
#     --sample_indices 10 20
