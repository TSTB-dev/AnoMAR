...
CONFIG_FILES=(
  "./configs/exp_dit_vae_loco/breakfast_box.yml"
  "./configs/exp_dit_vae_loco/juice_bottle.yml"
  "./configs/exp_dit_vae_loco/pushpins.yml"
  "./configs/exp_dit_vae_loco/screw_bag.yml"
  "./configs/exp_dit_vae_loco/splicing_connectors.yml"
)
