...
CONFIG_FILES=(
  "./configs/exp_emar_ca_enet_loco_enc_id/loco_emar_breakfast_box.yml"
  "./configs/exp_emar_ca_enet_loco_enc_id/loco_emar_juice_bottle.yml"
  "./configs/exp_emar_ca_enet_loco_enc_id/loco_emar_pushpins.yml"
  "./configs/exp_emar_ca_enet_loco_enc_id/loco_emar_screw_bag.yml"
  "./configs/exp_emar_ca_enet_loco_enc_id/loco_emar_splicing_connectors.yml"
)
